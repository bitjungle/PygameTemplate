...
def add_black_hole(pos):
    RAD = 20
    hole = objects.GameCircle(left=pos[0]-RAD, top=pos[1]-RAD, 
                              radius=RAD, color=color.black)
...
while running: # Main loop
    ...
    black_holes.draw(screen) # Drawing the sprite group
